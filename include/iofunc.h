...
void writeStdoutBlockData(std::vector<float> &);

void interleave(std::vector<float> &, std::vector<float> &, std::vector<float> &);
void deinterleave(std::vector<float> &, std::vector<float> &, std::vector<float> &);
